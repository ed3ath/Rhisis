...
public sealed class PlayerBankItemEntityConfiguration : IEntityTypeConfiguration<PlayerBankItemEntity>
{
    public void Configure(EntityTypeBuilder<PlayerBankItemEntity> builder)
    {
        ...
        builder.HasOne(x => x.Item)
            .WithOne()
            .HasForeignKey<PlayerBankItemEntity>(x => x.ItemId)
